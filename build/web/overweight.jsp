...
<body>
    ...
    <h1 style="text-align: center">Overweight</h1>
    <h3> ${bmiInfo}</h3>
    ...
    <table border="2">
        ...
        <tr>
            <td>Energy- 1800kcal </td>
         </tr>
          <tr>
            <td>Protein- 16%(150gms)</td>
             </tr>
              <tr>
            <td>Carbs-31%(280gms)</td>
             </tr>
              <tr>
            <td>Fats- 20%(90gms) </td>
             </tr>
    ...
    <h4>Generic Diet for OverWeight</h4>
    <table border="2">
        <tr>
            <td>Breakfast</td>
        ...
        <tr>
            <td>Dinner</td>
            <td>home food,nuts,fruits, lemon tea</td>
        </tr> 
    </table>
